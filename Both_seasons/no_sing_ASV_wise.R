...
cat("\n")
cat("example_sample_with_singleton_seq11_C9EB3_3_before_removal")
new_otu_mat["seq11","C9EB3_3"]
sdptre<-data.frame(sample_data(pert))

for (i in unique(sdptre$sample_root))
{
...
cat("\n")
cat("example_sample_with_singleton_seq11_C9EB3_3_after_removal")
new_otu_mat["seq11","C9EB3_3"]
