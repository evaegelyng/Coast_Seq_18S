...
assign_taxonomy <- function(table,lower_margin=2, remove = c("fungal sp.", "Eukaryota sp.", "Streptophyta sp.", "Opisthokonta sp.", "Dinophyceae sp.", "NA")) {       # EES removed constant upper margin specification
...
prefilter <- function(IDtable, lower_margin=2, remove = c("fungal sp.", "Eukaryota sp.", "Streptophyta sp.", "Opisthokonta sp.", "Dinophyceae sp.", "NA")) {   # EES removed constant upper_margin specification
...
my_classified_result <- assign_taxonomy(IDtable, lower_margin = 2, remove = c("fungal sp.", "Eukaryota sp.", "Streptophyta sp.", "Opisthokonta sp.", "Dinophyceae sp.", "NA")) # EES removed constant upper_margin specification
